...
@Mod(modid = "ICBM|Explosion", name = "ICBM|Explosion", version = "1.2.1",
     dependencies = "after:ICBM|Sentry;required-after:AtomicScience", useMetadata = true)
public class ICBMExplosion extends MainBase {
  ...
  @Mod.Instance("ICBM|Explosion") public static ICBMExplosion instance;
  @Mod.Metadata("ICBM|Explosion") public static ModMetadata metadata;
  @SidedProxy(clientSide = "icbm.zhapin.ClientProxy",
              serverSide = "icbm.zhapin.CommonProxy")
  ...
  public void preInit(final FMLPreInitializationEvent event) {
    ...
    ICBMExplosion.USE_FUEL =
        MainBase.CONFIGURATION
            .get("general", "Use Fuel", ICBMExplosion.USE_FUEL)
    ...
    BlockDispenser.dispenseBehaviorRegistry.putObject(
        ...
        (Object) new IBehaviorDispenseItem() {
          public ItemStack dispense(final IBlockSource blockSource,
            ...
            if (!world.isRemote) {
              ...
              final EGrenade entity = new EGrenade(world, new Vector3(x, y, z),
                                                   itemStack.getItemDamage());
              entity.setThrowableHeading(
                  enumFacing.getFrontOffsetX(), 0.10000000149011612,
    ...
    BlockDispenser.dispenseBehaviorRegistry.putObject(
        (Object)ICBMExplosion.itChe, (Object) new IBehaviorDispenseItem() {
          private final BehaviorDefaultDispenseItem
              defaultItemDispenseBehavior = new BehaviorDefaultDispenseItem();
            ...
            if (!world.isRemote) {
              ...
              if (BlockRailBase.func_150051_a(var11)) {
                ...
                if (var11 != Blocks.air ||
                  ...
                  return this.defaultItemDispenseBehavior.dispense(blockSource,
                                                                   itemStack);
                }
                var12 = -1.0;
              }
              final ECart var13 = new ECart(world, var5, var6 + var12, var7,
                                            itemStack.getItemDamage());
    ...
    GameRegistry.registerBlock(ICBMExplosion.bExplosives, IBExplosive.class,
                               "bExplosives");
    GameRegistry.registerBlock(ICBMExplosion.bJiQi, IBMachine.class, "bJiQi");
    ForgeChunkManager.setForcedChunkLoadingCallback(
        (Object)this,
        (ForgeChunkManager.LoadingCallback) new ForgeChunkManager
            .LoadingCallback() {
              public void ticketsLoaded(final List<Ticket> tickets,
                                        final World world) {
    ...
    int pktId = 0;
    channel.registerMessage(ItemUsePacketHandler.class, ItemUsePacket.class,
                            pktId++, Side.SERVER);
  }
  ...
  public void postInit(final FMLPostInitializationEvent event) {
    ...
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        ...
        new Object[] {"SCR", "SB ", 'R', ICBMExplosion.itLeiDaQiang, 'C',
                      new ItemStack(ICBMExplosion.bJiQi, 1,
                                    BMachine.JiQi.XiaoFaSheQi.ordinal() + 6),
                      'B', Blocks.stone_button, 'S', "ingotSteel"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack((Item)ICBMExplosion.itLeiDaQiang),
        new Object[] {"@#!", " $!", "  !", '@', Blocks.glass, '!', "ingotSteel",
                      '#', "calclavia:CIRCUIT_T1", '$', Blocks.stone_button}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack((Item)ICBMExplosion.itYaoKong),
        new Object[] {"?@@", "@#$", "@@@", '@', "ingotSteel", '?',
                      Items.redstone, '#', "calclavia:CIRCUIT_T2", '$',
                      Blocks.stone_button}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
    ...
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        ...
        new Object[] {"I  ", " W ", "  C", 'C', "calclavia:CIRCUIT_T2", 'W',
                      "calclavia:WRENCH", 'I', "calclavia:WIRE"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMExplosion.bJiQi, 1, 0),
        new Object[] {"! !", "!C!", "!!!", '!', "ingotBronze", 'C',
                      "calclavia:CIRCUIT_T1"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMExplosion.bJiQi, 1, 1),
        new Object[] {"! !", "!C!", "!@!", '@',
                      new ItemStack(ICBMExplosion.bJiQi, 1, 0), '!',
                      "ingotSteel", 'C', "calclavia:CIRCUIT_T2"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMExplosion.bJiQi, 1, 2),
        new Object[] {"! !", "!C!", "!@!", '@',
                      new ItemStack(ICBMExplosion.bJiQi, 1, 1), '!',
                      "plateSteel", 'C', "calclavia:CIRCUIT_T3"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMExplosion.bJiQi, 1, 3),
        new Object[] {"!!!", "!#!", "!?!", '#', "calclavia:CIRCUIT_T1", '!',
                      Blocks.glass, '?', "calclavia:WIRE"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMExplosion.bJiQi, 1, 4),
        new Object[] {"!$!", "!#!", "!?!", '#', "calclavia:CIRCUIT_T2", '!',
                      "ingotSteel", '?', "calclavia:WIRE", '$',
                      new ItemStack(ICBMExplosion.bJiQi, 1, 3)}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMExplosion.bJiQi, 1, 5),
        new Object[] {"!$!", "!#!", "!?!", '#', "calclavia:CIRCUIT_T3", '!',
                      Items.gold_ingot, '?', "calclavia:WIRE", '$',
                      new ItemStack(ICBMExplosion.bJiQi, 1, 4)}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
    ...
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        ...
        new Object[] {
            "?@?", " ! ", "!#!", '@',
            ElectricItemHelper.getUncharged(ICBMExplosion.itLeiDaQiang), '!',
            "plateSteel", '#', "calclavia:CIRCUIT_T1", '?', Items.gold_ingot}));
    RecipeHelper.addRecipe(
        (IRecipe) new ShapedOreRecipe(
            new ItemStack(ICBMExplosion.bJiQi, 1, 10),
            new Object[] {"?W?", "@!@", "?#?", '?', "plateSteel", '!',
                          "calclavia:CIRCUIT_T3", '@',
                          UniversalRecipes.BATTERY_BOX, '#', "calclavia:MOTOR",
                          'W', "calclavia:WIRE"}),
        "EMP Tower", MainBase.CONFIGURATION, true);
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
    ...
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMExplosion.itTeBieDaoDan),
        new Object[] {" @ ", "@#@", "@?@", '@', "ingotSteel", '?', Items.coal,
                      '#', "calclavia:CIRCUIT_T1"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMExplosion.itTeBieDaoDan, 1, 1),
        new Object[] {" B ", " C ", "BMB", 'M',
                      new ItemStack(ICBMExplosion.itTeBieDaoDan, 1, 0), 'C',
                      "calclavia:CIRCUIT_T1", 'B', "ingotBronze"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
    ...
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        ...
        new Object[] {" N ", "NCN", 'C',
                      new ItemStack(ICBMExplosion.itTeBieDaoDan, 1, 3), 'N',
    ...
    EntityRegistry.registerGlobalEntityID(
        EExplosive.class, "ICBMExplosive",
        EntityRegistry.findGlobalUniqueEntityId());
    EntityRegistry.registerGlobalEntityID(
        EMissile.class, "ICBMMissile",
        EntityRegistry.findGlobalUniqueEntityId());
    EntityRegistry.registerGlobalEntityID(
        EExplosion.class, "ICBMProceduralExplosion",
        EntityRegistry.findGlobalUniqueEntityId());
    EntityRegistry.registerGlobalEntityID(
        EGravityBlock.class, "ICBMGravityBlock",
        EntityRegistry.findGlobalUniqueEntityId());
    EntityRegistry.registerGlobalEntityID(
        ELightBeam.class, "ICBMLightBeam",
        EntityRegistry.findGlobalUniqueEntityId());
    EntityRegistry.registerGlobalEntityID(
        ESuiPian.class, "ICBMFragment",
        EntityRegistry.findGlobalUniqueEntityId());
    EntityRegistry.registerGlobalEntityID(
        EGrenade.class, "ICBMGrenade",
        EntityRegistry.findGlobalUniqueEntityId());
    EntityRegistry.registerGlobalEntityID(
        ECart.class, "ICBMChe", EntityRegistry.findGlobalUniqueEntityId());
    EntityRegistry.registerModEntity(EExplosive.class, "ICBMExplosive", 50,
                                     (Object)this, 50, 5, true);
    EntityRegistry.registerModEntity(EMissile.class, "ICBMMissile", 51,
                                     (Object)this, 500, 1, true);
    EntityRegistry.registerModEntity(EExplosion.class,
                                     "ICBMProceduralExplosion", 52,
                                     (Object)this, 100, 5, true);
    EntityRegistry.registerModEntity(EGravityBlock.class, "ICBMGravityBlock",
                                     53, (Object)this, 50, 15, true);
    EntityRegistry.registerModEntity(ELightBeam.class, "ICBMLightBeam", 54,
                                     (Object)this, 80, 5, true);
    EntityRegistry.registerModEntity(ESuiPian.class, "ICBMFragment", 55,
                                     (Object)this, 40, 8, true);
    EntityRegistry.registerModEntity(EGrenade.class, "ICBMGrenade", 56,
                                     (Object)this, 50, 5, true);
    EntityRegistry.registerModEntity(ECart.class, "ICBMChe", 58, (Object)this,
                                     50, 4, true);
    ICBMExplosion.proxy.init();
  }

  public static boolean shiBaoHu(final World world, final Vector3 diDian,
    ...
    case QUAN_BU: {
      baoHu = (FlagRegistry.getModFlag("ModFlags")
                   .containsValue(world, ICBMFlags.FLAG_BAN_MINECART, "true",
                                  diDian) ||
               FlagRegistry.getModFlag("ModFlags")
                   .containsValue(world, ICBMFlags.FLAG_BAN_MISSILE, "true",
                                  diDian) ||
               FlagRegistry.getModFlag("ModFlags")
                   .containsValue(world, ICBMFlags.FLAG_BAN_GRENADE, "true",
                                  diDian) ||
               FlagRegistry.getModFlag("ModFlags")
                   .containsValue(world, ICBMFlags.FLAG_BAN_EXPLOSIVE, "true",
                                  diDian));
      break;
    }
    case CHE: {
    ...
    case DAO_DAN: {
      baoHu =
          FlagRegistry.getModFlag("ModFlags")
              .containsValue(world, ICBMFlags.FLAG_BAN_MISSILE, "true", diDian);
      break;
    }
    case SHOU_LIU_DAN: {
      baoHu =
          FlagRegistry.getModFlag("ModFlags")
              .containsValue(world, ICBMFlags.FLAG_BAN_GRENADE, "true", diDian);
      break;
    }
    case ZHA_DAN: {
      baoHu = FlagRegistry.getModFlag("ModFlags")
