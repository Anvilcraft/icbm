...
public class TRadarTower extends TileEntityUniversalRunnable
  ...
  public void initiate() {
    ...
    if (this.ticket == null) {
      this.ticket = ForgeChunkManager.requestTicket(
          (Object)ICBMExplosion.instance, this.worldObj,
  ...
  private void doScan() {
    ...
    final List<Entity> entities = RadarRegistry.getEntitiesWithinRadius(
        new Vector3(this).toVector2(), 500);
    ...
    final List<EntityPlayer> players = this.worldObj.getEntitiesWithinAABB(
        ...
        AxisAlignedBB.getBoundingBox(
            (double)(this.xCoord - 500), (double)(this.yCoord - 500),
            (double)(this.zCoord - 500), (double)(this.xCoord + 500),
            (double)(this.yCoord + 500), (double)(this.zCoord + 500)));
  ...
  public boolean isWeiXianDaoDan(final EMissile daoDan) {
    return daoDan != null && daoDan.target != null &&
        Vector2.distance(new Vector3(daoDan).toVector2(),
                         new Vector2(this.xCoord, this.zCoord)) <
            this.alarmRadius &&
        Vector2.distance(daoDan.target.toVector2(),
                         new Vector2(this.xCoord, this.zCoord)) <
            this.safetyRadius;
  }
  ...
  public void onDestroy(final TileEntity callingBlock) {
    ...
    this.worldObj.setBlock(this.xCoord, this.yCoord + 1, this.zCoord,
                           Blocks.air, 0, 2);
    this.worldObj.setBlock(this.xCoord + 1, this.yCoord + 1, this.zCoord,
                           Blocks.air, 0, 2);
    this.worldObj.setBlock(this.xCoord - 1, this.yCoord + 1, this.zCoord,
                           Blocks.air, 0, 2);
    this.worldObj.setBlock(this.xCoord, this.yCoord + 1, this.zCoord + 1,
                           Blocks.air, 0, 2);
    this.worldObj.setBlock(this.xCoord, this.yCoord + 1, this.zCoord - 1,
                           Blocks.air, 0, 2);
    this.worldObj.setBlock(this.xCoord + 1, this.yCoord + 1, this.zCoord + 1,
                           Blocks.air, 0, 2);
    this.worldObj.setBlock(this.xCoord - 1, this.yCoord + 1, this.zCoord - 1,
                           Blocks.air, 0, 2);
    this.worldObj.setBlock(this.xCoord + 1, this.yCoord + 1, this.zCoord - 1,
  ...
  public boolean onActivated(final EntityPlayer entityPlayer) {
    ...
    entityPlayer.openGui((Object)ICBMExplosion.instance, 3, this.worldObj,
                         this.xCoord, this.yCoord, this.zCoord);
    return true;
  }
  ...
  public void onCreate(final Vector3 position) {
    MainBase.bJia.makeFakeBlock(
        this.worldObj, Vector3.add(new Vector3(0.0, 1.0, 0.0), position),
        new Vector3(this));
    MainBase.bJia.makeFakeBlock(
        this.worldObj, Vector3.add(new Vector3(1.0, 1.0, 0.0), position),
        new Vector3(this));
    MainBase.bJia.makeFakeBlock(
        this.worldObj, Vector3.add(new Vector3(-1.0, 1.0, 0.0), position),
        new Vector3(this));
    MainBase.bJia.makeFakeBlock(
        this.worldObj, Vector3.add(new Vector3(0.0, 1.0, 1.0), position),
        new Vector3(this));
    MainBase.bJia.makeFakeBlock(
        this.worldObj, Vector3.add(new Vector3(0.0, 1.0, -1.0), position),
        new Vector3(this));
    MainBase.bJia.makeFakeBlock(
        this.worldObj, Vector3.add(new Vector3(1.0, 1.0, -1.0), position),
        new Vector3(this));
    MainBase.bJia.makeFakeBlock(
        this.worldObj, Vector3.add(new Vector3(-1.0, 1.0, 1.0), position),
        new Vector3(this));
  ...
  @Override
  public Object[] callMethod(final IComputerAccess computer, ILuaContext ctx,
