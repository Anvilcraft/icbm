...
public class DAntiBallistic extends MissileBase {
  ...
  public void update(final EMissile missileObj) {
    if (missileObj.lockedTarget == null) {
      final AxisAlignedBB bounds = AxisAlignedBB.getBoundingBox(
          missileObj.posX - 30.0, missileObj.posY - 30.0,
          missileObj.posZ - 30.0, missileObj.posX + 30.0,
          missileObj.posY + 30.0, missileObj.posZ + 30.0);
      final Entity nearestEntity =
          missileObj.worldObj.findNearestEntityWithinAABB(
  ...
  public void onExplode(final EMissile missileObj) {
    missileObj.worldObj.createExplosion((Entity)missileObj, missileObj.posX,
                                        missileObj.posY, missileObj.posZ, 6.0f,
                                        true);
    MinecraftForge.EVENT_BUS.post(new ExplosionEvent.PostExplosionEvent(
        missileObj.worldObj, missileObj.posX, missileObj.posY, missileObj.posZ,
        this));
  }
