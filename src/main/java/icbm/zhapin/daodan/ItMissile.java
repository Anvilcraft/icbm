...
public class ItMissile extends ItICBM {
  ...
  public int getMetadata(final int damage) { return damage; }
  ...
  public String getUnlocalizedName() { return "icbm.missile"; }

  public void getSubItems(final int par1, final CreativeTabs par2CreativeTabs,
                           final List par3List) {
