...
public class ESuiPian
        extends EntityArrow implements IEntityAdditionalSpawnData {
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public ESuiPian(final World par1World, final double x, final double y,
            final double z, final boolean isExplosive,
    ...
    public void setVelocity(final double par1, final double par3,
        ...
        if (super.prevRotationPitch == 0.0f && super.prevRotationYaw == 0.0f) {
            ...
            this.setLocationAndAngles(super.posX, super.posY, super.posZ,
                    super.rotationYaw, super.rotationPitch);
        }
    }
    ...
    private void explode() {
        if (!this.isExploding && !super.worldObj.isRemote) {
            ...
            super.worldObj.createExplosion((Entity) this, (double) this.xTile,
                    (double) this.yTile, (double) this.zTile,
                    this.explosionSize, true);
            this.setDead();
        }
    }
    ...
    public void onUpdate() {
        //super.onUpdate();
        if (this.isAnvil) {
            final ArrayList<Entity> entities = new ArrayList<>(super.worldObj.getEntitiesWithinAABBExcludingEntity(
        ...
        if (super.prevRotationPitch == 0.0f && super.prevRotationYaw == 0.0f) {
            final float var6 = MathHelper.sqrt_double(super.motionX * super.motionX +
                    super.motionZ * super.motionZ);
            final float n = (float) (Math.atan2(super.motionX, super.motionZ) * 180.0 /
                    3.141592653589793);
            super.rotationYaw = n;
            super.prevRotationYaw = n;
            final float n2 = (float) (Math.atan2(super.motionY, var6) * 180.0 / 3.141592653589793);
            super.rotationPitch = n2;
            super.prevRotationPitch = n2;
        }
        Block var7 = super.worldObj.getBlock(this.xTile, this.yTile, this.zTile);
        if (var7 != Blocks.air) {
            var7.setBlockBoundsBasedOnState((IBlockAccess) super.worldObj, this.xTile,
            ...
            if (var8 != null && var8.isVecInside(Vec3.createVectorHelper(
        ...
        if (this.inGround) {
            ...
            final int var9 = super.worldObj.getBlockMetadata(this.xTile, this.yTile, this.zTile);
            if (var7 == this.inTile && var9 == this.inData) {
                if (this.isExplosive) {
                    this.explode();
                } else {
                    if (this.isAnvil && super.worldObj.rand.nextFloat() > 0.5f) {
                        super.worldObj.playAuxSFX(1022, (int) super.posX, (int) super.posY,
                                (int) super.posZ, 0);
                    }
                    this.setDead();
                }
            ...
            Vec3 var11 = Vec3.createVectorHelper(super.posX + super.motionX,
                    super.posY + super.motionY,
                    super.posZ + super.motionZ);
            // TODO: false? true?
            MovingObjectPosition movingObjPos = super.worldObj.rayTraceBlocks(var10, var11, false);
            var10 = Vec3.createVectorHelper(super.posX, super.posY, super.posZ);
            var11 = Vec3.createVectorHelper(super.posX + super.motionX,
                    super.posY + super.motionY,
                    super.posZ + super.motionZ);
            if (movingObjPos != null) {
                var11 = Vec3.createVectorHelper(movingObjPos.hitVec.xCoord,
                        movingObjPos.hitVec.yCoord,
                        movingObjPos.hitVec.zCoord);
            }
            Entity var12 = null;
            final List<Entity> var13 = super.worldObj.getEntitiesWithinAABBExcludingEntity(
                    (Entity) this,
                    super.boundingBox
            ...
            for (int var15 = 0; var15 < var13.size(); ++var15) {
                ...
                if (var16.canBeCollidedWith() && this.ticksInAir >= 5) {
                    ...
                    final MovingObjectPosition var19 = var18.calculateIntercept(var10, var11);
                    if (var19 != null) {
            ...
            if (movingObjPos != null) {
                if (movingObjPos.entityHit != null) {
                    ...
                    final DamageSource damageSource = new EntityDamageSourceIndirect("arrow", (Entity) this,
                            (Entity) this)
                            .setProjectile();
                    if (this.isBurning()) {
                    ...
                    if (movingObjPos.entityHit.attackEntityFrom(damageSource, damage)) {
                        if (movingObjPos.entityHit instanceof EntityLiving) {
                            final EntityLiving var21 = (EntityLiving) movingObjPos.entityHit;
                            if (!super.worldObj.isRemote) {
                                var21.setArrowCountInEntity(var21.getArrowCountInEntity() + 1);
                            }
                            if (this.knowBackStrength > 0) {
                                final float var22 = MathHelper.sqrt_double(super.motionX * super.motionX +
                                        super.motionZ * super.motionZ);
                                if (var22 > 0.0f) {
                        ...
                        super.worldObj.playSoundAtEntity(
                                (Entity) this, "random.bowhit", 1.0f,
                    ...
                    this.inData = super.worldObj.getBlockMetadata(this.xTile, this.yTile,
                            this.zTile);
            ...
            if (this.arrowCritical) {
                for (int var15 = 0; var15 < 4; ++var15) {
                    super.worldObj.spawnParticle(
                            "crit", super.posX + super.motionX * var15 / 4.0,
                            super.posY + super.motionY * var15 / 4.0,
                            super.posZ + super.motionZ * var15 / 4.0, -super.motionX,
                            -super.motionY + 0.2, -super.motionZ);
                }
            }
            super.posX += super.motionX;
            super.posY += super.motionY;
            super.posZ += super.motionZ;
            final float speed = MathHelper.sqrt_double(super.motionX * super.motionX +
                    super.motionZ * super.motionZ);
            super.rotationYaw = (float) (Math.atan2(super.motionX, super.motionZ) *
                    180.0 / 3.141592653589793);
            super.rotationPitch = (float) (Math.atan2(super.motionY, speed) * 180.0 / 3.141592653589793);
            ...
            if (this.isInWater()) {
                for (int var24 = 0; var24 < 4; ++var24) {
                    ...
                    super.worldObj.spawnParticle(
                            "bubble", super.posX - super.motionX * var25,
                            super.posY - super.motionY * var25,
                            super.posZ - super.motionZ * var25, super.motionX, super.motionY,
                            super.motionZ);
                }
                var23 = 0.8f;
            }
