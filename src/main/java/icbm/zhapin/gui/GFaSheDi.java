...
public class GFaSheDi extends GuiContainer {
    ...
    public GFaSheDi(final InventoryPlayer par1InventoryPlayer,
            final TLauncherPlatform tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer(final int par1,
            final int par2) {
        this.fontRendererObj.drawString("§7" + this.tileEntity.getInventoryName(), 48,
                6, 4210752);
