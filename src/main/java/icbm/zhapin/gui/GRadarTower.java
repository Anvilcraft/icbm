...
public class GRadarTower extends GuiBase {
    ...
    public GRadarTower(final TRadarTower tileEntity) {
        ...
        this.mouseOverCoords = new Vector2(this.tileEntity.xCoord, this.tileEntity.zCoord);
        super.xSize = 256;
        this.radarCenter = new Vector2(this.containerPosX + super.xSize / 3 - 14,
    ...
    public void initGui() {
        super.initGui();
        (this.textFieldSafetyZone = new GuiTextField(this.fontRendererObj, 155, 83, 30, 12))
                .setMaxStringLength(3);
        this.textFieldSafetyZone.setText(this.tileEntity.safetyRadius + "");
        (this.textFieldAlarmRange = new GuiTextField(this.fontRendererObj, 155, 110, 30, 12))
                .setMaxStringLength(3);
    ...
    public void keyTyped(final char par1, final int par2) {
        ...
        try {
            final int newSafetyRadius = Math.min(
                    500,
                    Math.max(0, Integer.parseInt(this.textFieldSafetyZone.getText())));
        ...
        try {
            final int newAlarmRadius = Math.min(
                    500,
                    Math.max(0, Integer.parseInt(this.textFieldAlarmRange.getText())));
    ...
    public void mouseClicked(final int par1, final int par2, final int par3) {
        ...
        this.textFieldAlarmRange.mouseClicked(par1 - this.containerPosX,
                par2 - this.containerPosY, par3);
        this.textFieldSafetyZone.mouseClicked(par1 - this.containerPosX,
                par2 - this.containerPosY, par3);
    }
    ...
    protected void drawBackgroundLayer(final int var2, final int var3,
        ...
        this.drawTexturedModalRect(this.containerPosX, this.containerPosY, 0, 0,
                super.xSize, super.ySize);
        this.radarCenter = new Vector2(this.containerPosX + super.xSize / 3 - 10,
                this.containerPosY + super.ySize / 2 + 4);
        ...
        if (this.tileEntity.prevWatts >= this.tileEntity.getRequest().getWatts()) {
            ...
            for (final Entity entity : this.tileEntity.xunZhaoEntity) {
                ...
                this.drawTexturedModalRect(position.intX(), position.intY(), 0, 0, 2,
                        2);
    ...
    public void updateScreen() {
        ...
        if (Mouse.isInsideWindow() && Mouse.getEventButton() == -1) {
            ...
            if (this.mousePosition.x > this.radarCenter.x - difference &&
                ...
                this.mouseOverCoords = new Vector2(this.tileEntity.xCoord + xBlockDistance,
