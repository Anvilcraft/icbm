...
public class GXiaoFaSheQi extends GuiContainer {
    ...
    public GXiaoFaSheQi(final InventoryPlayer par1InventoryPlayer,
    ...
    public void keyTyped(final char par1, final int par2) {
        ...
        try {
            final Vector3 newTarget = new Vector3(Integer.parseInt(this.textFieldX.getText()),
        ...
        try {
            final short newFrequency = (short) Math.max(Short.parseShort(this.textFieldFreq.getText()), 0);
    ...
    public void mouseClicked(final int par1, final int par2, final int par3) {
        ...
        this.textFieldX.mouseClicked(par1 - this.containerWidth,
                par2 - this.containerHeight, par3);
        this.textFieldZ.mouseClicked(par1 - this.containerWidth,
                par2 - this.containerHeight, par3);
        this.textFieldY.mouseClicked(par1 - this.containerWidth,
                par2 - this.containerHeight, par3);
    ...
    protected void drawGuiContainerForegroundLayer(final int par1,
            final int par2) {
        this.fontRendererObj.drawString("§7" + this.tileEntity.getInventoryName(), 52,
                6, 4210752);
        ...
        this.fontRendererObj.drawString(this.tileEntity.getStatus(), 70, 50,
                4210752);
        this.fontRendererObj.drawString(this.tileEntity.getVoltage() + "v", 70, 60,
                4210752);
