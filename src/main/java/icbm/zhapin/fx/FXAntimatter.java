...
public class FXAntimatter extends EntityFX {
    ...
    public FXAntimatter(final World par1World, final Vector3 position,
    ...
    public FXAntimatter(final World par1World, final Vector3 position,
            final double par8, final double par10, final double par12,
            final float par14, final double distance) {
    ...
    public void renderParticle(final Tessellator tessellator, final float par2,
        ...
        final float f11 = (float) (((Entity) this).prevPosX +
                (((Entity) this).posX - ((Entity) this).prevPosX) * par2 -
                EntityFX.interpPosX);
        final float f12 = (float) (((Entity) this).prevPosY +
                (((Entity) this).posY - ((Entity) this).prevPosY) * par2 -
                EntityFX.interpPosY);
        final float f13 = (float) (((Entity) this).prevPosZ +
        ...
        tessellator.addVertexWithUV(
                (double) (f11 - par3 * f10 - par5 * f10), (double) (f12 - par4 * f10),
                (double) (f13 - par5 * f10 - par7 * f10), 0.0, 1.0);
        tessellator.addVertexWithUV(
                (double) (f11 - par3 * f10 + par5 * f10), (double) (f12 + par4 * f10),
                (double) (f13 - par5 * f10 + par7 * f10), 1.0, 1.0);
        tessellator.addVertexWithUV(
                (double) (f11 + par3 * f10 + par5 * f10), (double) (f12 + par4 * f10),
                (double) (f13 + par5 * f10 + par7 * f10), 1.0, 0.0);
        tessellator.addVertexWithUV(
                (double) (f11 + par3 * f10 - par5 * f10), (double) (f12 - par4 * f10),
                (double) (f13 + par5 * f10 - par7 * f10), 0.0, 0.0);
        tessellator.draw();
        GL11.glDisable(3042);
