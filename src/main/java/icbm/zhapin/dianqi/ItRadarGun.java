...
public class ItRadarGun extends ItElectricICBM {
    ...
    public ItemStack onItemRightClick(final ItemStack itemStack,
        ...
        if (par2World.isRemote) {
            final MovingObjectPosition objectMouseOver = par3EntityPlayer.rayTrace(1000.0, 1.0f);
                    ...
                    if (this.getJoules(itemStack) > 1000.0) {
                        ICBMExplosion.channel.sendToServer(new ItemUsePacket(
                                ...
                                new Vector3(objectMouseOver.blockX, objectMouseOver.blockY,
                                        objectMouseOver.blockZ)));
                        this.onProvide(
                                ElectricityPack.getFromWatts(1000.0, this.getJoules(itemStack)),
                                itemStack);
        ...
        if (blockId == ICBMExplosion.bJiQi) {
            ...
            if (tileEntity != null) {
                if (tileEntity instanceof TLauncherControlPanel) {
                    final TLauncherControlPanel missileLauncher = (TLauncherControlPanel) tileEntity;
                    ...
                    if (!savedCords.equals(new Vector3())) {
                        ...
                        if (par3World.isRemote) {
                            ...
                            par2EntityPlayer.addChatMessage(
                                    new ChatComponentText("Coordinate information transfered!"));
                        }
