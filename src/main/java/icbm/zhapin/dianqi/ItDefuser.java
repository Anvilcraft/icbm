...
public class ItDefuser extends ItElectricICBM {
  ...
  public boolean onLeftClickEntity(final ItemStack itemStack,
    ...
    if (this.getJoules(itemStack) > 2000.0) {
      if (entity instanceof EExplosive) {
        if (!entity.worldObj.isRemote) {
          ...
          final EntityItem entityItem = new EntityItem(
              entity.worldObj, entity.posX, entity.posY, entity.posZ,
        ...
        if (!entity.worldObj.isRemote) {
          final EntityItem entityItem2 =
              new EntityItem(entity.worldObj, entity.posX, entity.posY,
                             entity.posZ, new ItemStack(Blocks.tnt));
          final float var14 = 0.05f;
          final Random random2 = new Random();
          ((Entity)entityItem2).motionX = (float)random2.nextGaussian() * var14;
          ((Entity)entityItem2).motionY =
              (float)random2.nextGaussian() * var14 + 0.2f;
          ((Entity)entityItem2).motionZ = (float)random2.nextGaussian() * var14;
      ...
      this.onProvide(
          ElectricityPack.getFromWatts(2000.0, this.getJoules(itemStack)),
          itemStack);
      return true;
    }
  ...
  public double getVoltage(final ItemStack itemStack) { return 20.0; }

  public double getMaxJoules(final ItemStack itemStack) { return 80000.0; }
}
