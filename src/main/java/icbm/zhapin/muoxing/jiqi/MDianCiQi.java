...
public class MDianCiQi extends ModelBase
{
    ...
    public MDianCiQi() {
        ...
        (this.Base = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 16, 6, 16);
        this.Base.setRotationPoint(-8.0f, 18.0f, -8.0f);
        this.Base.setTextureSize(128, 128);
        this.Base.mirror = true;
        this.setRotation(this.Base, 0.0f, 0.0f, 0.0f);
        (this.Support = new ModelRenderer((ModelBase)this, 0, 24)).addBox(0.0f, 0.0f, 0.0f, 10, 8, 10);
        ...
        (this.Turret_Support = new ModelRenderer((ModelBase)this, 0, 44)).addBox(-7.0f, 0.0f, -7.0f, 14, 1, 14);
        ...
        (this.Main_Coil = new ModelRenderer((ModelBase)this, 66, 0)).addBox(-2.0f, 0.0f, -2.0f, 4, 11, 4);
        ...
        (this.Support_Beam_A1 = new ModelRenderer((ModelBase)this, 66, 16)).addBox(8.0f, 0.0f, -1.0f, 1, 18, 2);
        ...
        (this.Support_Beam_B1 = new ModelRenderer((ModelBase)this, 73, 16)).addBox(-1.0f, 0.0f, -9.0f, 2, 18, 1);
        ...
        (this.Support_Beam_C1 = new ModelRenderer((ModelBase)this, 66, 16)).addBox(-9.0f, 0.0f, -1.0f, 1, 18, 2);
        ...
        (this.Support_Beam_D1 = new ModelRenderer((ModelBase)this, 73, 16)).addBox(-1.0f, 0.0f, 8.0f, 2, 18, 1);
        ...
        (this.Support_Beam_DB1 = new ModelRenderer((ModelBase)this, 85, 0)).addBox(-1.0f, 0.0f, -8.0f, 2, 1, 16);
        ...
        (this.Support_Beam_CA1 = new ModelRenderer((ModelBase)this, 85, 19)).addBox(-8.0f, 0.0f, -1.0f, 16, 1, 2);
        ...
        (this.Support_Beam_CA2 = new ModelRenderer((ModelBase)this, 85, 19)).addBox(-8.0f, 0.0f, -1.0f, 16, 1, 2);
        ...
        (this.Support_Beam_DB2 = new ModelRenderer((ModelBase)this, 85, 0)).addBox(-1.0f, 0.0f, -8.0f, 2, 1, 16);
