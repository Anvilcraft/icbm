...
public class MMYuanZi extends MICBM {
  ...
  public MMYuanZi() {
    ...
    (this.WARHEAD_1 = new ModelRenderer((ModelBase)this, 72, 91))
        .addBox(0.0f, 0.0f, 0.0f, 8, 6, 8);
    this.WARHEAD_1.setRotationPoint(-4.0f, -70.0f, -4.0f);
    this.WARHEAD_1.setTextureSize(128, 128);
    this.WARHEAD_1.mirror = true;
    this.setRotation(this.WARHEAD_1, 0.0f, 0.0f, 0.0f);
    (this.WARHEAD_2 = new ModelRenderer((ModelBase)this, 72, 106))
        .addBox(0.0f, 0.0f, 0.0f, 6, 6, 6);
    this.WARHEAD_2.setRotationPoint(-3.0f, -76.0f, -3.0f);
    this.WARHEAD_2.setTextureSize(128, 128);
    this.WARHEAD_2.mirror = true;
    this.setRotation(this.WARHEAD_2, 0.0f, 0.0f, 0.0f);
    (this.WARHEAD_3 = new ModelRenderer((ModelBase)this, 110, 91))
        .addBox(0.0f, 0.0f, 0.0f, 4, 6, 4);
    this.WARHEAD_3.setRotationPoint(-2.0f, -82.0f, -2.0f);
