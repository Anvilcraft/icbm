...
public class MMDuQi extends MICBM
{
    ...
    public MMDuQi() {
        ...
        (this.MAIN_MISSILE_MODULE = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 6, 50, 6);
        ...
        (this.MOTOR_MODULE = new ModelRenderer((ModelBase)this, 0, 57)).addBox(-5.0f, 0.0f, -5.0f, 10, 16, 10);
        ...
        (this.WING_B_A_1 = new ModelRenderer((ModelBase)this, 59, 26)).addBox(-1.0f, 0.0f, -9.0f, 2, 12, 18);
        ...
        (this.WING_B_B_1 = new ModelRenderer((ModelBase)this, 59, 26)).addBox(-1.0f, 0.0f, -9.0f, 2, 12, 18);
        ...
        (this.WING_T_B_1 = new ModelRenderer((ModelBase)this, 59, 0)).addBox(-1.0f, 0.0f, 0.0f, 2, 10, 10);
        ...
        (this.WING_T_A_1 = new ModelRenderer((ModelBase)this, 59, 0)).addBox(-1.0f, 0.0f, 0.0f, 2, 10, 10);
        ...
        (this.WING_T_B_2 = new ModelRenderer((ModelBase)this, 25, 0)).addBox(-1.0f, 0.0f, -7.0f, 2, 10, 14);
        ...
        (this.WING_T_A_2 = new ModelRenderer((ModelBase)this, 25, 0)).addBox(-1.0f, 0.0f, -7.0f, 2, 10, 14);
        ...
        (this.WING_B_B_2 = new ModelRenderer((ModelBase)this, 25, 26)).addBox(-1.0f, 0.0f, 0.0f, 2, 13, 13);
        ...
        (this.WING_B_A_2 = new ModelRenderer((ModelBase)this, 25, 26)).addBox(-1.0f, 0.0f, 0.0f, 2, 13, 13);
        ...
        (this.CHEMICAL_CONTROL_MODULE = new ModelRenderer((ModelBase)this, 0, 86)).addBox(-4.0f, 0.0f, -4.0f, 8, 8, 8);
        ...
        (this.CHEMICAL_CONDUCT = new ModelRenderer((ModelBase)this, 34, 86)).addBox(0.0f, 0.0f, 0.0f, 1, 24, 1);
        ...
        (this.CHEM_WARHEAD_1 = new ModelRenderer((ModelBase)this, 0, 103)).addBox(-4.0f, 0.0f, -4.0f, 8, 5, 8);
        ...
        (this.CHEM_WARHEAD_2 = new ModelRenderer((ModelBase)this, 40, 86)).addBox(-3.0f, 0.0f, -3.0f, 6, 5, 6);
