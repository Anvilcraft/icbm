...
public class MMShengBuo extends MICBM {
  ...
  public MMShengBuo() {
    ...
    (this.Shape7a = new ModelRenderer((ModelBase)this, 95, 115))
    ...
    (this.Shape7 = new ModelRenderer((ModelBase)this, 95, 103))
        .addBox(0.0f, 0.0f, 0.0f, 6, 4, 6);
    this.Shape7.setRotationPoint(-3.0f, -49.0f, -3.0f);
    this.Shape7.setTextureSize(128, 128);
    this.Shape7.mirror = true;
    this.setRotation(this.Shape7, 0.0f, 0.0f, 0.0f);
    (this.Shape7b = new ModelRenderer((ModelBase)this, 69, 109))
        .addBox(-1.0f, 0.0f, -5.0f, 2, 8, 10);
    this.Shape7b.setRotationPoint(0.0f, -48.0f, 0.0f);
    this.Shape7b.setTextureSize(128, 128);
    this.Shape7b.mirror = true;
    this.setRotation(this.Shape7b, 0.0f, 0.7853982f, 0.0f);
    (this.Shape7c = new ModelRenderer((ModelBase)this, 69, 109))
        .addBox(-1.0f, 0.0f, -5.0f, 2, 8, 10);
    this.Shape7c.setRotationPoint(0.0f, -48.0f, 0.0f);
    this.Shape7c.setTextureSize(128, 128);
    this.Shape7c.mirror = true;
    this.setRotation(this.Shape7c, 0.0f, -0.7853982f, 0.0f);
  }
