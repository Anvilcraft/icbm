...
public class MMYaSuo extends MICBM {
  ...
  public MMYaSuo() {
    ...
    this.WARHEAD_1.setRotationPoint(0.0f, -27.0f, 0.0f);
    this.WARHEAD_1.setTextureSize(128, 128);
    this.WARHEAD_1.mirror = true;
    this.setRotation(this.WARHEAD_1, 0.0f, 0.7853982f, 0.0f);
    (this.WARHEAD_2 = new ModelRenderer((ModelBase)this, 33, 85))
        .addBox(-3.0f, 0.0f, -3.0f, 6, 2, 6);
    this.WARHEAD_2.setRotationPoint(0.0f, -29.0f, 0.0f);
    this.WARHEAD_2.setTextureSize(128, 128);
    this.WARHEAD_2.mirror = true;
    this.setRotation(this.WARHEAD_2, 0.0f, 0.7853982f, 0.0f);
    (this.WARHEAD_3 = new ModelRenderer((ModelBase)this, 59, 85))
        .addBox(-2.0f, 0.0f, -2.0f, 4, 2, 4);
    this.WARHEAD_3.setRotationPoint(0.0f, -31.0f, 0.0f);
    this.WARHEAD_3.setTextureSize(128, 128);
    this.WARHEAD_3.mirror = true;
    this.setRotation(this.WARHEAD_3, 0.0f, 0.7853982f, 0.0f);
    (this.WARHEAD_4 = new ModelRenderer((ModelBase)this, 9, 87))
        .addBox(-1.0f, 0.0f, -1.0f, 2, 1, 2);
    this.WARHEAD_4.setRotationPoint(0.0f, -32.0f, 0.0f);
    this.WARHEAD_4.setTextureSize(128, 128);
    this.WARHEAD_4.mirror = true;
    this.setRotation(this.WARHEAD_4, 0.0f, 0.7853982f, 0.0f);
  }
