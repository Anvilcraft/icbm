...
public class MMBingDan extends MICBM {
  ...
  public MMBingDan() {
    ...
    (this.Shape1 = new ModelRenderer((ModelBase)this, 108, 92))
        .addBox(0.0f, 0.0f, 0.0f, 2, 6, 2);
    this.Shape1.setRotationPoint(-4.0f, -70.0f, -4.0f);
    this.Shape1.setTextureSize(128, 128);
    this.Shape1.mirror = true;
    this.setRotation(this.Shape1, 0.0f, 0.0f, 0.0f);
    (this.Shape1a = new ModelRenderer((ModelBase)this, 108, 92))
        .addBox(0.0f, 0.0f, 0.0f, 2, 6, 2);
    this.Shape1a.setRotationPoint(-4.0f, -70.0f, 2.0f);
    this.Shape1a.setTextureSize(128, 128);
    this.Shape1a.mirror = true;
    this.setRotation(this.Shape1a, 0.0f, 0.0f, 0.0f);
    (this.Shape1b = new ModelRenderer((ModelBase)this, 108, 92))
        .addBox(0.0f, 0.0f, 0.0f, 2, 6, 2);
    this.Shape1b.setRotationPoint(2.0f, -70.0f, -4.0f);
    this.Shape1b.setTextureSize(128, 128);
    this.Shape1b.mirror = true;
    this.setRotation(this.Shape1b, 0.0f, 0.0f, 0.0f);
    (this.Shape1c = new ModelRenderer((ModelBase)this, 108, 92))
        .addBox(0.0f, 0.0f, 0.0f, 2, 6, 2);
    this.Shape1c.setRotationPoint(2.0f, -70.0f, 2.0f);
    this.Shape1c.setTextureSize(128, 128);
    this.Shape1c.mirror = true;
    this.setRotation(this.Shape1c, 0.0f, 0.0f, 0.0f);
    (this.Shape1d = new ModelRenderer((ModelBase)this, 64, 92))
        .addBox(0.0f, 0.0f, 0.0f, 6, 10, 6);
    this.Shape1d.setRotationPoint(-3.0f, -74.0f, -3.0f);
    this.Shape1d.setTextureSize(128, 128);
    this.Shape1d.mirror = true;
    this.setRotation(this.Shape1d, 0.0f, 0.0f, 0.0f);
    (this.Shape1e = new ModelRenderer((ModelBase)this, 90, 92))
        .addBox(0.0f, 0.0f, 0.0f, 4, 6, 4);
    this.Shape1e.setRotationPoint(-2.0f, -80.0f, -2.0f);
