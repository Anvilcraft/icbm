...
public class MMFanDan extends MICBM {
  ...
  public MMFanDan() {
    ...
    (this.Shape3d = new ModelRenderer((ModelBase)this, 72, 0))
        .addBox(-11.0f, 0.0f, -1.0f, 22, 12, 2);
    this.Shape3d.setRotationPoint(0.0f, 12.0f, 0.0f);
    this.Shape3d.setTextureSize(128, 128);
    this.Shape3d.mirror = true;
    this.setRotation(this.Shape3d, 0.0f, 0.7853982f, 0.0f);
    ...
    (this.Shape3a = new ModelRenderer((ModelBase)this, 34, 0))
    ...
    this.setRotation(this.Shape3a, 0.0f, 0.7853982f, 0.7853982f);
    ...
    (this.Shape7a = new ModelRenderer((ModelBase)this, 72, 29))
        .addBox(0.0f, 0.0f, 0.0f, 8, 4, 8);
    this.Shape7a.setRotationPoint(-4.0f, -45.0f, -4.0f);
    this.Shape7a.setTextureSize(128, 128);
    this.Shape7a.mirror = true;
    this.setRotation(this.Shape7a, 0.0f, 0.0f, 0.0f);
    (this.Shape7 = new ModelRenderer((ModelBase)this, 72, 43))
        .addBox(0.0f, 0.0f, 0.0f, 6, 2, 6);
    this.Shape7.setRotationPoint(-3.0f, -47.0f, -3.0f);
    this.Shape7.setTextureSize(128, 128);
    this.Shape7.mirror = true;
    this.setRotation(this.Shape7, 0.0f, 0.0f, 0.0f);
    (this.Shape8 = new ModelRenderer((ModelBase)this, 63, 33))
        .addBox(0.0f, 0.0f, 0.0f, 2, 2, 2);
    this.Shape8.setRotationPoint(2.0f, -46.0f, -1.0f);
    this.Shape8.setTextureSize(128, 128);
    this.Shape8.mirror = true;
    this.setRotation(this.Shape8, 0.0f, 0.0f, -0.7853982f);
    (this.Shape8a = new ModelRenderer((ModelBase)this, 63, 33))
        .addBox(0.0f, 0.0f, 0.0f, 2, 2, 2);
    this.Shape8a.setRotationPoint(-5.0f, -46.0f, -1.0f);
    this.Shape8a.setTextureSize(128, 128);
    this.Shape8a.mirror = true;
    this.setRotation(this.Shape8a, 0.0f, 0.0f, -0.7853982f);
    (this.Shape8b = new ModelRenderer((ModelBase)this, 63, 33))
        .addBox(0.0f, 0.0f, 0.0f, 2, 2, 2);
    this.Shape8b.setRotationPoint(-1.0f, -46.0f, 2.0f);
    this.Shape8b.setTextureSize(128, 128);
    this.Shape8b.mirror = true;
    this.setRotation(this.Shape8b, 0.7853982f, 0.0f, 0.0f);
    (this.Shape8c = new ModelRenderer((ModelBase)this, 63, 33))
        .addBox(0.0f, 0.0f, 0.0f, 2, 2, 2);
    this.Shape8c.setRotationPoint(-1.0f, -46.0f, -5.0f);
    this.Shape8c.setTextureSize(128, 128);
    this.Shape8c.mirror = true;
    this.setRotation(this.Shape8c, 0.7853982f, 0.0f, 0.0f);
    (this.Shape8d = new ModelRenderer((ModelBase)this, 72, 53))
        .addBox(0.0f, 0.0f, 0.0f, 4, 2, 4);
    this.Shape8d.setRotationPoint(-2.0f, -49.0f, -2.0f);
