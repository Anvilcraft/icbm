            ...
            if (!worldObj.isRemote) {
                ...
                for (final Object obj : source.dataList1) {
                    ...
                    if (distanceFromCenter <= radius) {
                        ...
                        final Block blockID = worldObj.getBlock((int) targetPosition.x, (int) targetPosition.y,
                        ...
                        if (blockID == Blocks.fire || blockID == Blocks.lava ||
                            ...
                            worldObj.setBlock((int) targetPosition.x, (int) targetPosition.y,
                                    (int) targetPosition.z, Blocks.snow_layer, 0, 2);
                        } else {
                            if (blockID != Blocks.air ||
                                    worldObj.getBlock((int) targetPosition.x,
                                            (int) targetPosition.y - 1,
                                            (int) targetPosition.z) == Blocks.ice
                                    ||
                                    worldObj.getBlock((int) targetPosition.x,
                                            (int) targetPosition.y - 1,
                                            (int) targetPosition.z) == Blocks.air) {
                                continue;
                            }
                            worldObj.setBlock((int) targetPosition.x, (int) targetPosition.y,
                                    (int) targetPosition.z, Blocks.ice, 0, 2);
                        }
                    }
                }
            }
