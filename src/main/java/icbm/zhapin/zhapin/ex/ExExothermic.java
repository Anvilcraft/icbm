...
public class ExExothermic extends ZhaPin {
    ...
    public void onYinZha(final World worldObj, final Vector3 position,
        ...
        worldObj.spawnParticle("lava", position.x, position.y + 0.5, position.z,
                0.0, 0.0, 0.0);
    }
    ...
    public void baoZhaQian(final World worldObj, final Vector3 position,
        ...
        if (!worldObj.isRemote) {
            final ELightBeam lightBeam = new ELightBeam(worldObj, position, 400, 0.7f, 0.3f, 0.0f);
    ...
    public void init() {
        RecipeHelper.addRecipe(
                (IRecipe) new ShapedOreRecipe(this.getItemStack(),
                        new Object[] { "!!!", "!@!", "!!!", '@',
                                Blocks.glass, '!',
