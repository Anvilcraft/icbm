            ...
            for (int i = 0; i < amount; ++i) {
                ...
                for (int ii = 0; ii < amount; ++ii) {
                    final ESuiPian arrow = new ESuiPian(
                            worldObj, position.x, position.y, position.z, this.getTier() == 2,
                    ...
                    arrow.setThrowableHeading(arrow.motionX * worldObj.rand.nextFloat(),
                            ...
                            0.5f + 0.7f * worldObj.rand.nextFloat(), 1.0f);
        ...
        if (this.getID() == ZhaPin.shrapnel.getID()) {
            ...
            RecipeHelper.addRecipe(
                    (IRecipe) new ShapedOreRecipe(
                            ...
                            new Object[] { "SSS", "SAS", "SSS", 'A', Blocks.anvil, 'S',
            ...
            RecipeHelper.addRecipe(
                    (IRecipe) new ShapedOreRecipe(
                            this.getItemStack(),
                            new Object[] { " @ ", "@?@", " @ ", '?', ZhaPin.indenciary.getItemStack(),
                                    '@', ZhaPin.shrapnel.getItemStack() }),
                    this.getUnlocalizedName(), MainBase.CONFIGURATION, true);
        }
    }
