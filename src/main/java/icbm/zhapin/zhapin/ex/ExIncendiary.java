        ...
        for (int x = 0; x < radius; ++x) {
            for (int y = 0; y < radius; ++y) {
                for (int z = 0; z < radius; ++z) {
                    if (x == 0 || x == radius - 1 || y == 0 || y == radius - 1 ||
                            z == 0 || z == radius - 1) {
                        ...
                        for (float var18 = 0.3f; var14 > 0.0f; var14 -= var18 * 0.75f) {
                            ...
                            final Block var19 = worldObj.getBlock(targetPosition.intX(),
                                    targetPosition.intY(),
                                    targetPosition.intZ());
                            if (var19 != Blocks.air) {
                            ...
                            if (var14 > 0.0f) {
                                ...
                                if (chance > distanceFromCenter * 0.55) {
                                    ...
                                    if ((block == Blocks.air ||
                                        ...
                                        worldObj.setBlock((int) targetPosition.x,
        ...
        RecipeHelper.addRecipe(
                (IRecipe) new ShapedOreRecipe(
                        ...
                        new Object[] { "@@@", "@?@", "@!@", '@', "dustSulfur", '?',
                                ZhaPin.repulsive.getItemStack(), '!', Items.lava_bucket }),
