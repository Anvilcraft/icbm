...
public class EGrenade
    ...
    public EGrenade(final World par1World, final Vector3 position,
    ...
    public EGrenade(final World par1World, final EntityLivingBase par2EntityLiving,
            final int explosiveID, final float nengLiang) {
        this(par1World);
        ...
        this.setLocationAndAngles(
                ...
                ((Entity) par2EntityLiving).posZ, ((Entity) par2EntityLiving).rotationYaw,
        ...
        this.setThrowableHeading(super.motionX, super.motionY, super.motionZ,
                1.8f * nengLiang, 1.0f);
        this.haoMa = explosiveID;
    }
    ...
    public void onUpdate() {
        if (!super.worldObj.isRemote &&
                ICBMExplosion.shiBaoHu(super.worldObj, new Vector3(this),
                        ZhaPin.ZhaPinType.SHOU_LIU_DAN, this.haoMa)) {
            final float var6 = 0.7f;
            final double var7 = super.worldObj.rand.nextFloat() * var6 + (1.0f - var6) * 0.5;
            final double var8 = super.worldObj.rand.nextFloat() * var6 + (1.0f - var6) * 0.5;
            final double var9 = super.worldObj.rand.nextFloat() * var6 + (1.0f - var6) * 0.5;
            final EntityItem var10 = new EntityItem(
                    super.worldObj, super.posX + var7, super.posY + var8,
                    super.posZ + var9,
        ...
        final float var11 = MathHelper.sqrt_double(super.motionX * super.motionX +
                super.motionZ * super.motionZ);
        super.rotationYaw = (float) (Math.atan2(super.motionX, super.motionZ) *
                180.0 / 3.141592653589793);
        super.rotationPitch = (float) (Math.atan2(super.motionY, var11) * 180.0 / 3.141592653589793);
        ...
        if (this.isInWater()) {
            for (int var13 = 0; var13 < 4; ++var13) {
                ...
                super.worldObj.spawnParticle(
                        "bubble", super.posX - super.motionX * var14,
                        super.posY - super.motionY * var14,
                        super.posZ - super.motionZ * var14, super.motionX, super.motionY,
                        super.motionZ);
            }
            var12 = 0.8f;
        }
        ...
        if (super.ticksExisted > Math.max(60, ZhaPin.list[this.haoMa].getYinXin())) {
            ...
            ZhaPin.createExplosion(super.worldObj,
                    new Vector3(super.posX, super.posY, super.posZ),
                    this, this.haoMa);
            this.setDead();
        } else {
            ZhaPin.list[this.haoMa].onYinZha(
                    super.worldObj, new Vector3(super.posX, super.posY + 0.5, super.posZ),
                    super.ticksExisted);
        }
    }
