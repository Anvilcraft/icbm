...
public class ItGrenade extends ItICBM {
    ...
    public ItemStack onItemRightClick(final ItemStack itemStack,
        ...
        if (itemStack != null) {
            ...
            if (!ICBMExplosion.shiBaoHu(world, new Vector3((Entity) entityPlayer),
                    ZhaPin.ZhaPinType.SHOU_LIU_DAN, haoMa)) {
    ...
    public void onPlayerStoppedUsing(final ItemStack itemStack, final World world,
        ...
        if (!world.isRemote) {
            ...
            if (!ICBMExplosion.shiBaoHu(world, new Vector3((Entity) entityPlayer),
                ...
                world.playSoundAtEntity(entityPlayer, "random.fuse", 0.5f,
                        0.4f /
                                (Item.itemRand.nextFloat() * 0.4f + 0.8f));
                world.spawnEntityInWorld(
                        new EGrenade(world, entityPlayer, haoMa,
