...
public class RFeiBlock extends Render {
    ...
    public void doRenderGravityBlock(final EGravityBlock entity, final double x,
        ...
        if (block == Blocks.dragon_egg || block == Blocks.grass ||
                block == Blocks.fence || block == Blocks.wheat ||
                block == Blocks.leaves || block == Blocks.redstone_torch ||
                block == Blocks.torch || block == Blocks.tallgrass ||
                block == Blocks.vine || block == Blocks.log ||
            ...
            this.field_147909_c.renderBlockByRenderType(
                    block, MathHelper.floor_double(entity.posX),
    ...
    public void renderBlockGravity(final Block block, final int metadata,
    ...
    public void doRender(final Entity par1Entity, final double par2,
            ...
            final float par9) {
        this.doRenderGravityBlock((EGravityBlock) par1Entity, par2, par4, par6, par8,
                par9);
    }
