...
public class RZhaPin extends Render {
    ...
    public void doRender(final Entity entity, final double x, final double y,
        ...
        if (eZhaPin.haoMa == ZhaPin.redMatter.getID()) {
            ...
            tessellator.addVertexWithUV((double) (-size), 0.0, (double) (-size),
                    (double) x3, (double) x5);
            tessellator.addVertexWithUV((double) (-size), 0.0, (double) size,
                    (double) x3, (double) x4);
            tessellator.addVertexWithUV((double) size, 0.0, (double) size, (double) x2,
                    (double) x4);
            tessellator.addVertexWithUV((double) size, 0.0, (double) (-size),
                    (double) x2, (double) x5);
            tessellator.draw();
            ...
            for (int i1 = 0; i1 < (var41 + var41 * var41) / 2.0f * 60.0f; ++i1) {
                ...
                tessellator.addVertex(-0.866 * var44, (double) var43,
                        (double) (-0.5f * var44));
                tessellator.addVertex(0.866 * var44, (double) var43,
                        (double) (-0.5f * var44));
            ...
            if (data != null) {
                ...
                ((MICBM) data[0])
                        .render((Entity) eZhaPin, (float) x, (float) y, (float) z, par8, par9,
                                0.0625f);
                GL11.glPopMatrix();
            }
        }
