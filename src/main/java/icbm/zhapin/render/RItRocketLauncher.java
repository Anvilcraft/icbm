...
public class RItRocketLauncher implements IItemRenderer {
    ...
    public boolean shouldUseRenderHelper(final IItemRenderer.ItemRenderType type,
            final ItemStack item,
            final IItemRenderer.ItemRendererHelper helper) {
        return item.getItem() == ICBMExplosion.itFaSheQi;
    }

    public void renderItem(final IItemRenderer.ItemRenderType type,
            final ItemStack item, final Object... data) {
        GL11.glPushMatrix();
        ...
        if (type == IItemRenderer.ItemRenderType.INVENTORY) {
            ...
            final boolean isFirstPerson = Minecraft.getMinecraft().gameSettings.thirdPersonView == 0;
