...
public class RSuiPian extends Render {
    public void renderArrow(final ESuiPian suiPian, final double par2,
        ...
        if (suiPian.isAnvil) {
            ...
            this.bindTexture(
                    new ResourceLocation("minecraft", "textures/terrain.png"));
            // yay anvilcraft
            ...
            this.field_147909_c.renderBlockByRenderType(
                    block, MathHelper.floor_double(suiPian.posX),
            ...
            this.bindTexture(
                    new ResourceLocation("icbm", "textures/models/fragment.png"));
            GL11.glPushMatrix();
            GL11.glTranslatef((float) par2, (float) par4, (float) par6);
            GL11.glRotatef(
