...
public class ECart extends EntityMinecartTNT
    implements IExplosiveContainer, IEntityAdditionalSpawnData {
  public int haoMa;
  ...
  public ECart(final World par1World, final double x, final double y,
               final double z, final int explosiveID) {
  ...
  protected void explodeCart(final double par1) {
    ((Entity)this)
        .worldObj.spawnParticle("hugeexplosion", ((Entity)this).posX,
                                ((Entity)this).posY, ((Entity)this).posZ, 0.0,
                                0.0, 0.0);
    ZhaPin.createExplosion(((Entity)this).worldObj, new Vector3((Entity)this),
                           (Entity)this, this.haoMa);
    this.setDead();
  }
  ...
  public void killMinecart(final DamageSource par1DamageSource) {
    ...
    if (((EntityMinecart)this).getCommandSenderName() != null) {
      itemstack.setStackDisplayName(
          ((EntityMinecart)this).getCommandSenderName());
    }
    this.entityDropItem(itemstack, 0.0f);
    final double d0 = ((Entity)this).motionX * ((Entity)this).motionX +
                      ((Entity)this).motionZ * ((Entity)this).motionZ;
    if (!par1DamageSource.isExplosion()) {
      this.entityDropItem(new ItemStack(ICBMExplosion.bExplosives, 1, this.haoMa),
                          0.0f);
    }
