...
public class EntityTileDamagable
  ...
  @Override
  public boolean attackEntityFrom(final DamageSource source,
                                  final float amount) {
  ...
  public void readSpawnData(final ByteBuf data) {
    try {
      final TileEntity tileEntity =
          ((Entity)this)
              .worldObj.getTileEntity(data.readInt(), data.readInt(),
                                      data.readInt());
  ...
  public void onUpdate() {
    if (!((Entity)this).worldObj.isRemote) {
      if (this.host == null || this.host.isInvalid()) {
        ...
        this.setPosition(this.host.xCoord + 0.5, (double)this.host.yCoord,
  ...
  public AxisAlignedBB getCollisionBox(final Entity par1Entity) {
    return AxisAlignedBB.getBoundingBox(
        ((Entity)this).posX - 0.6, ((Entity)this).posY - 0.6,
        ((Entity)this).posZ - 0.6, ((Entity)this).posX + 0.6,
        ((Entity)this).posY + 0.6, ((Entity)this).posZ + 0.6);
  }
  ...
  public boolean interact(final EntityPlayer player) {
    if (this.host != null && player != null) {
      final Block block =
          ((Entity)this)
              .worldObj.getBlock(this.host.xCoord, this.host.yCoord,
                                 this.host.zCoord);
      if (block != null) {
        return block.onBlockActivated(((Entity)this).worldObj, this.host.xCoord,
                                      this.host.yCoord, this.host.zCoord,
                                      player, 0, 0.0f, 0.0f, 0.0f);
      }
    }
    return false;
  }
