...
public class ModelTurretMed extends ModelBase {
  ...
  public void setRotationAngles(final float par1, final float par2,
    ...
    final ModelRenderer[] Body = {this.Center,   this.FRBrace,  this.BRBrace,
                                  this.FLBrace,  this.BLBrace,  this.FLBrace2,
                                  this.FLBrace3, this.FRBrace2, this.FRBrace3,
                                  this.BRBrace2, this.BRBrace3, this.BLBrace3,
                                  this.BLBrace2, this.neck};
