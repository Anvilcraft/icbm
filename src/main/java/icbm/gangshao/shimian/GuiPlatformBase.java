...
public abstract class GuiPlatformBase extends GuiBase {
    ...
    public GuiPlatformBase(final EntityPlayer player,
    ...
    public void initGui() {
        ...
        this.buttonList.add(
                new GuiButtonImage(0, (this.width - super.xSize) / 2 - 22,
                        (this.height - super.ySize) / 2 + 0, 3));
        this.buttonList.add(
                new GuiButtonImage(1, (this.width - super.xSize) / 2 - 22,
                        (this.height - super.ySize) / 2 + 22, 0));
        this.buttonList.add(
                new GuiButtonImage(2, (this.width - super.xSize) / 2 - 22,
                        (this.height - super.ySize) / 2 + 44, 2));
        // TODO: WTF
