...
public abstract class GuiPlatformContainer extends GuiContainer {
    ...
    public GuiPlatformContainer(final InventoryPlayer inventoryPlayer,
    ...
    public void initGui() {
        ...
        this.buttonList.add(
                new GuiButtonImage(0, (this.width - this.xSize) / 2 - 22,
                        (this.height - this.ySize) / 2 + 0, 3));
        this.buttonList.add(
                new GuiButtonImage(1, (this.width - this.xSize) / 2 - 22,
                        (this.height - this.ySize) / 2 + 22, 0));
        this.buttonList.add(
                new GuiButtonImage(2, (this.width - this.xSize) / 2 - 22,
                        (this.height - this.ySize) / 2 + 44, 2));
    }
            ...
            switch (button.id) {
                case 0: {
                    this.entityPlayer.openGui(
                            (Object) ICBMSentry.instance, 1, this.tileEntity.getWorldObj(),
                ...
                case 1: {
                    this.entityPlayer.openGui(
                            (Object) ICBMSentry.instance, 2, this.tileEntity.getWorldObj(),
                            this.tileEntity.xCoord, this.tileEntity.yCoord,
                            this.tileEntity.zCoord);
                    break;
                }
                case 2: {
                    this.entityPlayer.openGui(
                            (Object) ICBMSentry.instance, 0, this.tileEntity.getWorldObj(),
                            this.tileEntity.xCoord, this.tileEntity.yCoord,
                            this.tileEntity.zCoord);
                    break;
                }
    ...
    protected void func_74189_g(final int x, final int y) {
        if (this.tileEntity.getTurret(false) != null) {
            ...
            this.fontRendererObj.drawString(
                    "§7" + title, (int) (this.xSize / 2 - title.length() * 2.5), 4,
                    4210752);
    ...
    public void drawTooltip(final int x, final int y, final String... toolTips) {
        ...
        if (toolTips != null) {
            ...
            this.drawGradientRect(var6 - 3, var7 - 4, var6 + var5 + 3, var7 - 3, var9,
                    var9);
            ...
            this.drawGradientRect(var6 - 4, var7 - 3, var6 - 3, var7 + var8 + 3, var9,
                    var9);
