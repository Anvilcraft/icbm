...
public class GuiButtonImage extends GuiButton {
    ...
    public GuiButtonImage(final int par1, final int par2, final int par3,
            final int type) {
    ...
    public void func_73737_a(final Minecraft par1Minecraft, final int width,
            final int hight) {
        // TODO: WTf
        // if (this.drawButton) {
        ...
        this.drawTexturedModalRect(this.xPosition, this.yPosition, var6, var5,
