...
public class TAATurret extends TAutomaticTurret {
    ...
    public AxisAlignedBB getTargetingBox() {
        return AxisAlignedBB.getBoundingBox(this.xCoord - this.getDetectRange(),
    ...
    public void playFiringSound() {
        this.worldObj.playSoundEffect((double) this.xCoord, (double) this.yCoord,
                (double) this.zCoord, "icbm.aagun", 5.0f,
                1.0f);
    }
    ...
    public Vector3 getMuzzle() {
        return new Vector3(this)
                ...
                .add(CalculationHelper
                        .getDeltaPositionFromRotation(super.currentRotationYaw,
