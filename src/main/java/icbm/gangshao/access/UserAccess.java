...
public class UserAccess {
  ...
  public UserAccess(final String user, final AccessLevel level,
                    final boolean save) {
    this.username = user;
    this.level = level;
  ...
  public static List<UserAccess> readListFromNBT(final NBTTagCompound nbt,
  ...
  public static void writeListToNBT(final NBTTagCompound save,
