...
public class ItTracker extends ItElectricICBM implements ITracker {
    ...
    public void registerIcons(final IIconRegister par1IconRegister) {
        if (par1IconRegister instanceof TextureMap) {
            ...
            .setTextureEntry(this.getUnlocalizedName().replace("item.", ""),
                             new TextureTracker());
    ...
    @Override
    public void setTrackingEntity(final ItemStack itemStack,
                                  final Entity entity) {
    ...
    @Override
    public Entity getTrackingEntity(final World worldObj,
                                    final ItemStack itemStack) {
        if (worldObj != null && itemStack.stackTagCompound != null) {
            final int trackingID = itemStack.stackTagCompound.getInteger("trackingEntity");
    ...
    @Override
    public void onCreated(final ItemStack par1ItemStack, final World par2World,
                          final EntityPlayer par3EntityPlayer) {
        super.onCreated(par1ItemStack, par2World, par3EntityPlayer);
        this.setTrackingEntity(par1ItemStack, (Entity) par3EntityPlayer);
    }

    public void onUpdate(final ItemStack itemStack, final World par2World,
        ...
        if (par3Entity instanceof EntityPlayer) {
            ...
            if (player.inventory.getCurrentItem() != null &&
                ...
                final Entity trackingEntity = this.getTrackingEntity(par2World, itemStack);
                if (trackingEntity != null) {
                    this.onProvide(ElectricityPack.getFromWatts(
    ...
    public boolean onLeftClickEntity(final ItemStack itemStack,
        ...
        if (!((Entity) player).worldObj.isRemote) {
            ...
            player.addChatMessage(
                new ChatComponentText("Tracker out of electricity!"));
        }
        return false;
    }
