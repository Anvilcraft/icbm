...
public class BSpikes extends BICBM {
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(final World par1World,
        ...
        return AxisAlignedBB.getBoundingBox((double) x, (double) y, (double) z,
                (double) (x + 1), (double) (y + 0.5f),
                (double) (z + 1));
    }

    @Override
    public AxisAlignedBB getCollisionBoundingBoxFromPool(final World par1World, final int par2,
    ...
    public boolean canBlockStay(final World par1World, final int par2,
            final int par3, final int par4) {
        return par1World.isSideSolid(par2 - 1, par3, par4,
                ...
                ||
                par1World.isSideSolid(par2, par3 + 1, par4,
    ...
    @Override
    public void onEntityCollidedWithBlock(final World par1World, final int par2,
            final int par3, final int par4,
