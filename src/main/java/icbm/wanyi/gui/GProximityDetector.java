...
public class GProximityDetector extends GuiBase {
  ...
  public void initGui() {
    ...
    this.buttonList.add(new GuiButton(0, this.width / 2 - 15,
                                      this.height / 2 + 32, 45, 20, mode));
    (this.textFieldFreq =
         new GuiTextField(this.fontRendererObj, 75, 100, 40, 12))
        .setMaxStringLength(4);
    this.textFieldFreq.setText(this.tileEntity.frequency + "");
    (this.textFieldminX =
         new GuiTextField(this.fontRendererObj, 75, 50, 20, 12))
        .setMaxStringLength(2);
    this.textFieldminX.setText(this.tileEntity.minCoord.intX() + "");
    (this.textFieldminY =
         new GuiTextField(this.fontRendererObj, 75, 67, 20, 12))
        .setMaxStringLength(2);
    this.textFieldminY.setText(this.tileEntity.minCoord.intY() + "");
    (this.textFieldminZ =
         new GuiTextField(this.fontRendererObj, 75, 82, 20, 12))
        .setMaxStringLength(2);
    this.textFieldminZ.setText(this.tileEntity.minCoord.intZ() + "");
    (this.textFieldmaxX =
         new GuiTextField(this.fontRendererObj, 130, 50, 20, 12))
        .setMaxStringLength(2);
    this.textFieldmaxX.setText(this.tileEntity.maxCoord.intX() + "");
    (this.textFieldmaxY =
         new GuiTextField(this.fontRendererObj, 130, 67, 20, 12))
        .setMaxStringLength(2);
    this.textFieldmaxY.setText(this.tileEntity.maxCoord.intY() + "");
    (this.textFieldmaxZ =
         new GuiTextField(this.fontRendererObj, 130, 82, 20, 12))
        .setMaxStringLength(2);
  ...
  public void keyTyped(final char par1, final int par2) {
    ...
    try {
      final Vector3 newMinCoord =
          new Vector3(Integer.parseInt(this.textFieldminX.getText()),
    ...
    try {
      final Vector3 newMaxCoord =
          new Vector3(Integer.parseInt(this.textFieldmaxX.getText()),
    ...
    try {
      final short newFrequency = (short)Math.max(
          0, Short.parseShort(this.textFieldFreq.getText()));
  ...
  public void mouseClicked(final int par1, final int par2, final int par3) {
    ...
    this.textFieldminX.mouseClicked(par1 - this.containerWidth,
                                    par2 - this.containerHeight, par3);
    this.textFieldminY.mouseClicked(par1 - this.containerWidth,
                                    par2 - this.containerHeight, par3);
    this.textFieldminZ.mouseClicked(par1 - this.containerWidth,
                                    par2 - this.containerHeight, par3);
    this.textFieldmaxX.mouseClicked(par1 - this.containerWidth,
                                    par2 - this.containerHeight, par3);
    this.textFieldmaxY.mouseClicked(par1 - this.containerWidth,
                                    par2 - this.containerHeight, par3);
    this.textFieldmaxZ.mouseClicked(par1 - this.containerWidth,
                                    par2 - this.containerHeight, par3);
    this.textFieldFreq.mouseClicked(par1 - this.containerWidth,
                                    par2 - this.containerHeight, par3);
  }
  ...
  protected void drawForegroundLayer(final int var2, final int var3,
    ...
    if (this.tileEntity.isDisabled()) {
      status = "Disabled";
    } else if (this.tileEntity.prevWatts <
               this.tileEntity.getRequest().getWatts()) {
      status = "Insufficient electricity!";
    } else {
      color = "§2";
      status = "On";
    }
    this.fontRendererObj.drawString(color + "Status: " + status, 12, 138,
                                  4210752);
    this.fontRendererObj.drawString(
        ElectricityDisplay.getDisplay(this.tileEntity.getRequest().getWatts() *
                                          20.0,
