...
public class GSignalDisrupter extends GuiBase {
  ...
  public void initGui() {
    ...
    (this.textFieldFrequency =
         new GuiTextField(this.fontRendererObj, 80, 50, 40, 12))
        .setMaxStringLength(4);
    this.textFieldFrequency.setText(((IItemFrequency)this.itemStack.getItem())
                                        .getFrequency(this.itemStack) +
                                    "");
  }
  ...
  public void keyTyped(final char par1, final int par2) {
    ...
    try {
      final short newFrequency = (short)Math.max(
          0, Short.parseShort(this.textFieldFrequency.getText()));
      this.textFieldFrequency.setText(newFrequency + "");
      if (((IItemFrequency)this.itemStack.getItem())
              .getFrequency(this.itemStack) != newFrequency) {
