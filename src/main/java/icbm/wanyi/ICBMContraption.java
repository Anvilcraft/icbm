...
@Mod(modid = "ICBM|Contraption", name = "ICBM|Contraption", version = "1.2.1",
     dependencies = "required-after:AtomicScience", useMetadata = true)
public class ICBMContraption extends MainBase {
  ...
  @Mod.Instance("ICBM|Contraption") public static ICBMContraption instance;
  @Mod.Metadata("ICBM|Contraption") public static ModMetadata metadata;
  @SidedProxy(clientSide = "icbm.wanyi.ClientProxy",
              serverSide = "icbm.wanyi.CommonProxy")
  ...
  public void preInit(final FMLPreInitializationEvent event) {
    ...
    GameRegistry.registerBlock(ICBMContraption.bGlassPressurePlate,
                               "bGlassPressurePlate");
    GameRegistry.registerBlock(ICBMContraption.bGlassButton, "bGlassButton");
    GameRegistry.registerBlock(ICBMContraption.bProximityDetector,
                               "bProximityDetector");
    GameRegistry.registerBlock(ICBMContraption.bCamouflage, "bCamouflage");
    GameRegistry.registerBlock(ICBMContraption.bGlassReinforced,
                               "bGlassReinforced");
    GameRegistry.registerBlock(ICBMContraption.bSpikes, IBSpikes.class,
                               "bSpikes");
    GameRegistry.registerBlock(ICBMContraption.bConcrete, IBConcrete.class,
                               "bConcrete");

    GameRegistry.registerItem(ICBMContraption.itAntidote, "itAntidote");
    GameRegistry.registerItem(ICBMContraption.itSignalDisrupter,
                              "itSignalDisrupter");
    ...
    int pktId = 0;
    channel.registerMessage(SetSignalDisrupterFrequencyPacketHandler.class,
                            SetSignalDisrupterFrequencyPacket.class, pktId++,
                            Side.SERVER);
    channel.registerMessage(ProximityDetectorModePacketHandler.class,
                            ProximityDetectorModePacket.class, pktId++,
                            Side.SERVER);
  }
  ...
  public void postInit(final FMLPostInitializationEvent event) {
    ...
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMContraption.bSpikes, 6),
        new Object[] {"CCC", "BBB", 'C', Blocks.cactus, 'B',
                      Items.iron_ingot}));
    GameRegistry.addRecipe(new ItemStack(ICBMContraption.bSpikes, 1, 1),
                           new Object[] {"E", "S", 'E', MainBase.itDu, 'S',
                                         ICBMContraption.bSpikes});
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMContraption.bSpikes, 1, 2),
        new Object[] {"E", "S", 'E', "dustSulfur", 'S',
                      ICBMContraption.bSpikes}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMContraption.bCamouflage, 12),
        new Object[] {"WGW", "GCG", "WGW", 'C', "calclavia:CIRCUIT_T1", 'G',
                      Blocks.glass, 'W',
    ...
    if (OreDictionary.getOres(UniversalRecipes.BATTERY).size() > 0) {
      GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
          ...
          new Object[] {
              " Z ", "SBS", "SCS", 'Z', Items.compass, 'C',
              "calclavia:CIRCUIT_T1", 'B',
    ...
    GameRegistry.addRecipe(new ItemStack(ICBMContraption.bGlassButton, 2),
                           new Object[] {"G", "G", 'G', Blocks.glass});
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        ICBMContraption.bProximityDetector,
        new Object[] {
            "SSS", "S?S", "SSS", 'S', "ingotSteel", '?',
            ElectricItemHelper.getUncharged(ICBMContraption.itTracker)}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        (Item)ICBMContraption.itSignalDisrupter,
        new Object[] {"WWW", "SCS", "SSS", 'S', "ingotSteel", 'C',
                      "calclavia:CIRCUIT_T1", 'W', "calclavia:WIRE"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
    ...
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        ...
        new Object[] {"SGS", "GWG", "SGS", 'G', Blocks.gravel, 'S', Blocks.sand,
                      'W', Items.water_bucket}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMContraption.bConcrete, 8, 1),
        new Object[] {"COC", "OCO", "COC", 'C',
                      new ItemStack(ICBMContraption.bConcrete, 1, 0), 'O',
                      Blocks.obsidian}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMContraption.bConcrete, 8, 2),
        new Object[] {"COC", "OCO", "COC", 'C',
                      new ItemStack(ICBMContraption.bConcrete, 1, 1), 'O',
                      "ingotSteel"}));
    GameRegistry.addRecipe((IRecipe) new ShapedOreRecipe(
        new ItemStack(ICBMContraption.bGlassReinforced, 8),
        new Object[] {"IGI", "GIG", "IGI", 'G', Blocks.glass, 'I',
                      Items.iron_ingot}));
