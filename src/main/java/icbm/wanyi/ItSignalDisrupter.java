    ...
    public void onUpdate(final ItemStack itemStack, final World par2World, final Entity par3Entity, final int par4, final boolean par5) {
        if (!par2World.isRemote) {
            ...
            if (this.getJoules(itemStack) > 1.0) {
                this.onProvide(ElectricityPack.getFromWatts(1.0, this.getJoules(itemStack)), itemStack);
            }
        }
    }
    
    public ItemStack onItemRightClick(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer) {
        par3EntityPlayer.openGui((Object)ICBMContraption.instance, 5, par2World, (int)((Entity)par3EntityPlayer).posX, (int)((Entity)par3EntityPlayer).posY, (int)((Entity)par3EntityPlayer).posZ);
