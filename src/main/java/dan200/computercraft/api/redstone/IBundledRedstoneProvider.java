 ...
 * @see
 *     dan200.computercraft.api.ComputerCraftAPI#registerBundledRedstoneProvider(IBundledRedstoneProvider)
 */
public interface IBundledRedstoneProvider {
     ...
     * @see
     *     dan200.computercraft.api.ComputerCraftAPI#registerBundledRedstoneProvider(IBundledRedstoneProvider)
     * @return a number in the range 0-65535 to indicate this block is providing output,
     *     or -1 if you do not wish to handle this block
     */
