 ...
 * ITurtleAccess.issueCommand
 * @see
 *     ITurtleAccess#executeCommand(dan200.computercraft.api.lua.ILuaContext,ITurtleCommand)
 */
public interface ITurtleCommand {
    /**
     * Will be called by the turtle on the main thread when it is time to execute the
     * custom command. The handler should either perform the work of the command, and
     * return success, or return failure with an error message to indicate the command
